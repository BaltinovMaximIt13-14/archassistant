...
public class OllamaService {
    ...
    private String buildPrompt(String task, String context, String historyContext) {
        return """
            ...
            ## ТРЕБОВАНИЯ К ОТВЕТУ:
            1. Название решения (должно отражать суть)
            2. Краткое описание (2-3 предложения)
            3. Архитектурные компоненты (список с пояснениями)
            4. Схема взаимодействия компонентов (текстовое описание)
            5. Соответствие стандартам (какие стандарты применены)
            6. Технологический стек (рекомендуемые технологии)
            ...
            [список рисков и способов их mitigation]
            
            ## 📊 Ожидаемые результаты
            [какие бизнес-выгоды получит заказчик]
    ...
    private String buildValidationPrompt(String solution, String standardsContext) {
        return """
            ...
            2. Полнота описания компонентов
            3. Наличие необходимых нефункциональных требований
            4. Соблюдение best practices
            5. Потенциальные проблемы и уязвимости
            
            ## ФОРМАТ ОТВЕТА:
            ### 📊 Оценка соответствия: [Соответствует / Частично соответствует / Не соответствует]
            
            ### ✅ Соответствующие стандартам аспекты:
            - [пункт 1]
            - [пункт 2]
